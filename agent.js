class LLMAgent {
    ...
    initializeUI() {
        ...
        this.addMessage('agent', 'Welcome to PromptHub! Your all-in-one AI hub for searching, automating, and coding. Power up with your API keys or dive straight in—what will you create today?');
...
Available workflows for ai_pipe: summarize, analyze_sentiment, extract_keywords, translate`;
    ...
    getMockLLMResponse() {
        ...
        // Default responses
        const responses = [
            "Got it! How would you like to continue?",
            "Alright. What should we work on next?",
            "I'm here—what would you like me to do?",
            "Understood. How can I assist you further?",
            "Okay, what’s the next step you’d like to take?",
            "Sounds good! How can I support you now?",
            "I’m ready whenever you are. What’s next?"
        ];
